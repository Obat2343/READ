...
if args.name == "":
    ...
    dir_name = f"ContinuousDiff_{cfg.SDE.NAME}_CG_rank_{cfg.RETRIEVAL.RANK}_frame_{args.frame}"
...
Train_loss = losses.get_loss_fn_CG(sde, target=cfg.MODEL.TARGET, train=True, reduce_mean=True, continuous=cfg.SDE.TRAINING.CONTINUOUS,
                                    likelihood_weighting=False)
Val_loss = losses.get_loss_fn_CG(sde, target=cfg.MODEL.TARGET, train=False, reduce_mean=True, continuous=cfg.SDE.TRAINING.CONTINUOUS,
                                    likelihood_weighting=False)
