...
from pycode.DMOEBM.Motion_Gen import VAE, VAE_Loss, Single_Class_TransformerVAE
...
for task_name in task_list:
    ...
    if args.log2wandb:
        wandb.login()
        run = wandb.init(project='VAE-{}-{}'.format(cfg.DATASET.NAME, cfg.DATASET.RLBENCH.TASK_NAME), 
