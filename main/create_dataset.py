...
parser.add_argument('--mode_list', nargs="*", type=str, default=["train", "val", "test"]) # ["train", "val"]
parser.add_argument('--num_data', nargs="*", type=int, default=[1000, 100, 100])
...
parser.add_argument('--server_path', type=str, default="") # if server_path == "", dataset is not copied to server. Hint: tendon@dl20:/misc/dl001/dataset/ooba
